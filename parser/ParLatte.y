...
MIdent :: {
  (Maybe (Int, Int), MIdent (Maybe (Int, Int)))
}
: Ident {
  (fst $1, AbsLatte.MIdent (fst $1)(snd $1)) 
}
...
: Type MIdent '(' ListArg ')' Block {
  (fst $1, AbsLatte.FnDef (fst $1)(snd $1)(snd $2)(snd $4)(snd $6)) 
}
| 'class' MIdent ClassExt '{' ListClMember '}' {
...
ClassExt :: {
  (Maybe (Int, Int), ClassExt (Maybe (Int, Int)))
}
: {
  (Nothing, AbsLatte.EmptyExt Nothing)
}
| 'extends' MIdent {
  (Just (tokenLineCol $1), AbsLatte.Ext (Just (tokenLineCol $1)) (snd $2)) 
}
...
: Type MIdent ';' {
  (fst $1, AbsLatte.Field (fst $1)(snd $1)(snd $2)) 
}
| Type MIdent '(' ListArg ')' Block {
  (fst $1, AbsLatte.Method (fst $1)(snd $1)(snd $2)(snd $4)(snd $6)) 
}
...
| 'null' {
  (Just (tokenLineCol $1), AbsLatte.ELitNull (Just (tokenLineCol $1)))
}
| Expr6 '(' ListExpr ')' {
