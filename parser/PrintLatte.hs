...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    For _ type_ mident expr stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 mident, doc (showString ":"), prt 0 expr, doc (showString ")"), prt 0 stmt])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
